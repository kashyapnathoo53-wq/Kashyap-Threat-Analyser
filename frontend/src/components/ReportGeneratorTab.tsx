      ...
      <div className="glass-panel p-6 rounded-3xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h3 className="text-base font-extrabold text-white flex items-center gap-2">
              <FileText className="w-5 h-5 text-lime-400" /> Executive &amp; Technical Threat Dossier
            </h3>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 bg-gradient-to-r from-lime-600 via-olive-600 to-lime-500 hover:from-lime-500 hover:to-olive-500 text-slate-950 font-black rounded-xl text-xs transition shadow-lg shadow-lime-950/30"
          >
        ...
        <div className="glass-card rounded-3xl p-6 border border-white/[0.08] space-y-3">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-lime-500 hover:bg-lime-400 text-slate-950 font-black rounded-lg text-xs transition"
            >
