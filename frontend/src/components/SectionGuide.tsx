    ...
    <div className="glass-card rounded-2xl overflow-hidden border border-white/[0.08] shadow-2xl transition-all duration-300 mb-6 group">
      ...
      >
        <div className="flex items-center gap-3.5">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-cyan-600/25 to-teal-700/35 border border-cyan-500/40 flex items-center justify-center text-cyan-400 shrink-0 shadow-inner">
            <BookOpen className="w-4 h-4" />
          </div>
          <div>
            <div className="flex items-center gap-2.5">
              <h4 className="text-sm font-extrabold text-white tracking-wide">{title}</h4>
              <span className="px-2.5 py-0.5 text-[10px] uppercase font-mono font-black rounded-full bg-cyan-950/90 text-cyan-300 border border-cyan-500/40 shadow-sm">
                {badge}
              </span>
            </div>
        ...
        <button 
          ...
          className="text-xs font-mono font-bold text-cyan-300 hover:text-white flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900/90 border border-cyan-500/30 hover:border-cyan-400 hover:bg-cyan-950/60 transition shadow-sm cursor-pointer"
        >
      ...
      {isExpanded && (
        <div className="px-5 pb-5 pt-2 border-t border-white/[0.06] space-y-4 text-xs animate-fadeIn bg-slate-950/40">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* What it does */}
            <div className="glass-card p-4 rounded-xl border border-cyan-900/40 bg-slate-900/60">
              <div className="flex items-center gap-2 text-cyan-400 font-black mb-2 text-xs uppercase tracking-wider">
